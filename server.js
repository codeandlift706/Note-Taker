...
//POST /api/notes should receive a new note to save on the req body, add it to the db.json file, and then return the new note to the client. Give each note a unique id when it's saved 
